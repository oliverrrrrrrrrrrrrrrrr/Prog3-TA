...
namespace CampusStoreWeb
{
    public partial class DetalleArticulo : System.Web.UI.Page
    {
        ...
        private void MostrarDatosArticulo()
        {
            ...
            //lblDescuento.Text = articuloActual.descuento.valorDescuento.ToString();
            ...
            // Descripción
            lblDescripcion.Text = !string.IsNullOrEmpty(articuloActual.descripcion)
        ...
        private void CargarFormularioEdicion()
        {
            ...
            if (articuloActual.tipoArticulo.ToString() != null)
            {
                var catItem = ddlCategoria.Items.FindByValue(articuloActual.tipoArticulo.ToString());
                if (catItem != null)
                {
                    ddlCategoria.SelectedValue = articuloActual.tipoArticulo.ToString();
                }
