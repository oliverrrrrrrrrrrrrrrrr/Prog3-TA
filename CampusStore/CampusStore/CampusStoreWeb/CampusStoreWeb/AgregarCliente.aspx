<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AgregarCliente.aspx.cs" Inherits="CampusStoreWeb.AgregarCliente" %>
        ...
        <div class="formulario-card">
            ...
            <div class="info-box">
                ...
                <div class="info-box-content">
                    ...
                    <p>Complete todos los campos requeridos (*) para agregar el nuevo cliente al sistema.</p>
                </div>
            </div>
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtNombre" runat="server" placeholder="Ej: María García López"></asp:TextBox>
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtUsername" runat="server" placeholder="Ej: mgarcia"></asp:TextBox>
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtCorreo" runat="server" TextMode="Email" placeholder="Ej: mgarcia@email.com"></asp:TextBox>
...
<script type="text/javascript">
    function mostrarModalExito() {
        ...
        Swal.fire({
            title: '¡Éxito!',
            text: 'Cliente agregado con exito :D',
            icon: 'success',
