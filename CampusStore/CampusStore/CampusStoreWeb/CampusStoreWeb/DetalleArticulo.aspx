<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DetalleArticulo.aspx.cs" Inherits="CampusStoreWeb.DetalleArticulo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Detalle del Artículo</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <asp:Panel ID="pnlDetalle" runat="server" CssClass="detalle-card">
            ...
            <div class="detalle-header">
                <div class="detalle-title">
                    ...
                    <span class="detalle-id">
                        Artículo ID: #<asp:Label ID="lblArticuloID" runat="server" Text=""></asp:Label>
                    </span>
                </div>
            ...
            <!-- Formulario de Edición del Artículo -->
