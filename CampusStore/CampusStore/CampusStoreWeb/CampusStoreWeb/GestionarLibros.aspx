...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="breadcrumb-custom">
        <div class="container">
            <h2 class="mb-0">Gestionar Libros</h2>
        </div>
    </div>
            ...
            <div class="col-lg-9 col-md-8">
                <div class="libros-card">
                    ...
                    <div class="btn-agregar-container">
                        <asp:LinkButton ID="btnAgregarLibro" runat="server" CssClass="btn-agregar-articulo" OnClick="btnAgregarLibro_Click" CausesValidation="false">
