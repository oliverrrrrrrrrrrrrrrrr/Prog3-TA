...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="breadcrumb-custom">
        <div class="container">
            <h2 class="mb-0">Gestionar Artículos</h2>
        </div>
    </div>
            ...
            <div class="col-lg-9 col-md-8">
                <div class="articulos-card">
                    ...
                    <div class="btn-agregar-container">
                        <asp:LinkButton ID="btnAgregarArticulo" runat="server" CssClass="btn-agregar-articulo" OnClick="btnAgregarArticulo_Click" CausesValidation="false">
