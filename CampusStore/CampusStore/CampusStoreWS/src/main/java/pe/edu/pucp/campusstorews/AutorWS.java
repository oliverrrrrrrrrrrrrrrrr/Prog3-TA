...
public class AutorWS {
    ...
    private final String NOMBRE_RESOURCE = "autores";
    ...
    public List<Autor> listarAutores() 
        ...
        List<Autor> modelo = 
                mapper.readValue(json, new TypeReference<List<Autor>>() {});
    ...
    public Autor obtenerAutor(
        ...
        String json = response.body();
        ObjectMapper mapper= new ObjectMapper();
        Autor modelo = mapper.readValue(json, Autor.class);
    ...
    public void guardarAutor(
        ...
        if (estado == Estado.Nuevo) {
            ...
            url = this.urlBase + "/" + this.NOMBRE_RESOURCE + "/" + modelo.getIdAutor();
            request = HttpRequest.newBuilder()
                    .uri(URI.create(url))
                    .header("Content-Type", "application/json")
