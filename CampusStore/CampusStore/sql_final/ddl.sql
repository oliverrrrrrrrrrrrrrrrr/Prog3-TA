...
-- -----------------------------------------------------
-- -----------------------------------------------------
-- Schema libreriaCampusStore2
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `libreriaCampusStore2` ;

-- -----------------------------------------------------
-- Schema libreriaCampusStore2
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `libreriaCampusStore2` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
